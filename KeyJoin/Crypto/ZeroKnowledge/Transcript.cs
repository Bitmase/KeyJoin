...
public sealed class Transcript
{
	...
	public Transcript(byte[] label)
		: this(new Strobe128(ProtocolConstants.KeyJoinProtocolIdentifier))
	{
	...
	public SyntheticSecretNonceProvider CreateSyntheticSecretNonceProvider(IEnumerable<Scalar> secrets, BitmaseRandom random)
