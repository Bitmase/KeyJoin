namespace KeyJoin.Crypto.ZeroKnowledge;
...
internal partial class ProofSystem
{
	...
	public static IEnumerable<Proof> Prove(Transcript transcript, IEnumerable<Knowledge> knowledge, BitmaseRandom random)
	{
	...
	// expect nonce provider instead of BitmaseRandom?
	public static (Knowledge knowledge, IEnumerable<GroupElement> bitCommitments) RangeProofKnowledge(Scalar a, Scalar r, int width, BitmaseRandom rnd)
	{
