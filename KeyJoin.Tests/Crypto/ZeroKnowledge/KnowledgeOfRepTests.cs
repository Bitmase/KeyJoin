...
using KeyJoin.Crypto.Groups;
using KeyJoin.Crypto.Randomness;
using KeyJoin.Crypto.ZeroKnowledge.LinearRelation;
using BitmaseWallet.Tests.Helpers;

namespace KeyJoin.Tests.Crypto.ZeroKnowledge;
...
public class KnowledgeOfRepTests
{
	...
	public void End2EndVerificationSimple(uint scalarSeed1, uint scalarSeed2)
	{
		...
		var mockRandom = new Mock<BitmaseRandom>(MockBehavior.Strict);
