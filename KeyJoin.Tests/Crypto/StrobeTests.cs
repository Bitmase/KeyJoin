...
using System.Text;
using KeyJoin.Crypto.StrobeProtocol;
using KeyJoin.Helpers;
...
public class Strobe128Tests
{
	...
	public void BehaiorIsDeterministic()
	{
		...
		strobe1.AddAssociatedMetaData(ToBytes("keyjoin://unitests/"), false);
		strobe1.AddAssociatedMetaData(ToBytes("greeting/"), true);
		strobe1.AddAssociatedData(ToBytes("hello"), false);

		strobe2.AddAssociatedMetaData(ToBytes("keyjoin://unitests/"), false);
